...
var URL1 = "https://api.openweathermap.org/data/2.5/weather?q=Madrid,es&APPID=c76cfc6c188343ce9a77b5fc2edbce93";
...
fetch(URL1).then(function (response) {
  ...
  text1.textContent = "Temp: ".concat(Math.round(res1.main.temp - 273), " deg");
  text2.textContent = "Feels-like: ".concat(Math.round(res1.main.feels_like - 273), " deg");
  text3.textContent = "Humidity: ".concat(res1.main.humidity, "%");
}).catch(function (err) {
...
fetch(URL2).then(function (response) {
  ...
  res2 = r;
  console.log(res2);
  text4.textContent = "Name: ".concat(res2[0].name);
  text5.textContent = "Email: ".concat(res2[0].email);
  text6.textContent = "Company name: ".concat(res2[0].company.name);
}).catch(function (err) {
  return console.log(err);
});
var res3;
fetch(URL3).then(function (response) {
  ...
  text7.textContent = "Name: ".concat(res3.person1.name);
  text8.textContent = "Age: ".concat(res3.person1.age);
  text9.textContent = "Hobbies: ".concat(res3.person1.hobbies);
}).catch(function (err) {
  return console.log(err);
});
